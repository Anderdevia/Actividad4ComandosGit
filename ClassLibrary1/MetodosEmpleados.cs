...
namespace CapaDatos
{
    public class ClsMetodosEmpleados
    {
        ...
        public ClsMetodosEmpleados(String objNombre, Object objValor)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
        ...
        public ClsMetodosEmpleados(String objNombre, Object objValor, SqlDbType objTipoDato, ParameterDirection objDireccion, int objTamaño)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
