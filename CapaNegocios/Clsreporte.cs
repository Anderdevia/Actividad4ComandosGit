   ...
   public   class Clsreporte
    {
        ...
        public String Registrefinal()
        {
           ...
           try
          {
                ...
                lst.Add(new ClsMetodosEmpleados("@estado", Id));
                ...
                lst.Add(new ClsMetodosEmpleados("@rendimiento", Rendi));
                ...
                lst.Add(new ClsMetodosEmpleados("@improhorario ", A));
                lst.Add(new ClsMetodosEmpleados("@totalimpro", B));
                lst.Add(new ClsMetodosEmpleados("@resulimpro", C));
                ...
                M.EjecutarSP("registrreporte", ref lst);
                mensj = lst[21].Valor.ToString();
        ...
        public String Elimireport()
        {
            ...
            try
            {
                ...
                M.EjecutarSP("eliminereporte", ref lst);
        ...
        public String Elimireportcedu()
        {
            ...
            try
            {
                ...
                M.EjecutarSP("eliminereportecedul", ref lst);
                mensj = lst[1].Valor.ToString();
            }
            catch (Exception ex)
            {
        ...
        public String Elimireporttotal()
        {
            ...
            try
            {
               // lst.Add(new ClsMetodosEmpleados("@cedulaid", Cedula));
                ...
                M.EjecutarSP("eleliminereportetotal", ref lst);
